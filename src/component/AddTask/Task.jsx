...
const Task = ({ taskdetails, HandleDeleteTask, handleMarkCompleted}) => {
  ...
  const {setEditId}= useContext(taskDataProvider)
  ...
  return (
    <div>
      <ul className='flex items-center justify-evenly w-[375px] h-10  border '>
        ...
        <li><MdModeEditOutline className='text-gray-600 text-2xl cursor-pointer' title='edit' onClick={()=>handleEditTask(taskdetails.id)}/></li>
      </ul>
